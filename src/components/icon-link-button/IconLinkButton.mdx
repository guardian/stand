...
See the "Custom Component Build" section in the [`IconButton` documentation](/docs/stand-tools-design-system-components-iconbutton--docs#custom-component-build) for guidance on building a custom LinkButton component without React/Emotion.
