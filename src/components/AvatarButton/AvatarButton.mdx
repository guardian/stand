...
<Canvas layout="padded" of={InitialsMd} />

#### `sm`

<Canvas layout="padded" of={InitialsSm} />
...
<Canvas layout="padded" of={SingleInitial} />

### Images

#### Image - `md`

<Canvas layout="padded" of={ImageMd} />

#### Image - `sm`

<Canvas layout="padded" of={ImageSm} />

#### Image with fallback

When an image fails to load, the avatar falls back to displaying initials:

<Canvas layout="padded" of={ImageWithFallback} />

### Colors

<Canvas layout="padded" of={DefaultColors} />
...
```tsx
import type { AvatarButtonTheme } from '@guardian/stand/AvatarButton';
import { AvatarButton } from '@guardian/stand/AvatarButton';
import { baseColors, baseSizing } from '@guardian/stand';

const customTheme: AvatarButtonTheme = {
	shared: {
		color: {
			blue: {
...
const Component = () => (
	<AvatarButton color="blue" initials="CT" size="md" theme={customTheme} />
);
```

### CSS overrides

The `cssOverrides` prop allows you to pass custom CSS to the AvatarButton component, if the theme prop is not sufficient:
