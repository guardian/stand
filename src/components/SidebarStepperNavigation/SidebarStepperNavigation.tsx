...
function getStepNumberColor(
	...
	if (isHovered || isCurrent) {
		return theme.step.shared.text.inverseColor;
	}

	if (isDisabled) {
		return theme.step.shared.text.disabledColor;
	}
...
function StepNumber({
	...
	return (
		<Typography
			element="div"
			theme={{
				color: getStepNumberColor(theme, isHovered, isCurrent, isDisabled),
			}}
