...
/* Tool name only */
<TopBarToolName name="Songwriter" favicon={{ letter: 'S' }} />;
...
| `href`           | `string`                                                          | No       | N/A     | Optional destination URL for the link.                                                                    |
| `hoverText`      | `string`                                                          | No       | N/A     | Optional label for the link shown on hover. Must be provided if a link is.                                |
...
<Canvas layout="padded" of={WithName} />

### With content type

<Canvas layout="padded" of={WithSubsection} />

### With link

<Canvas layout="padded" of={WithLink} />
