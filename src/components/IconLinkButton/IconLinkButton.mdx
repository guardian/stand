...
```tsx
import { IconLinkButton } from '@guardian/stand/IconLinkButton';
import type {
	IconLinkButtonProps,
	IconLinkButtonTheme,
} from '@guardian/stand/IconLinkButton';
...
<Canvas layout="padded" of={IconLinkButtonTable} />
...
```tsx
import type { IconLinkButtonTheme } from '@guardian/stand/IconLinkButton';
import { IconLinkButton } from '@guardian/stand/IconLinkButton';
