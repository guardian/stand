...
const menuItemStyle = menuItemBaseStyle + \`
	grid-template-areas: \${menuItem.shared['grid-template-areas']};
\`;

const menuItemWithDescriptionStyle = menuItemBaseStyle + \`
	...
	<div style="\${popoverStyle}">
		<div style="\${menuStyle}">
			<div>
				...
				<div style="\${menuItemWithDescriptionStyle}" tabindex="0">
					<span class="material-symbols" style="\${menuItemIconStyle}">open_in_new</span>
					<span style="\${menuItemLabelStyle}">Open</span>
					<span style="\${menuItemDescriptionStyle}">Open in a new tab</span>
					<span style="\${menuItemAsideStyle}">⌘O</span>
				</div>
				<div style="\${menuItemWithDescriptionStyle}" tabindex="0">
					<span style="\${menuItemLabelStyle}">Rename</span>
					<span style="\${menuItemDescriptionStyle}">Rename the file</span>
				</div>
				<div style="\${menuItemStyle}" tabindex="0">
					<span style="\${menuItemLabelStyle}">Delete</span>
				</div>
			</div>
			<div style="\${separatorStyle}"></div>
			<div>
				<div style="\${menuItemStyle}" tabindex="0">
					<span class="material-symbols" style="\${menuItemIconStyle}">check_box</span>
					<span style="\${menuItemLabelStyle}">Show files</span>
				</div>
				<div style="\${menuItemStyle}" tabindex="0">
					<span class="material-symbols" style="\${menuItemIconStyle}">check_box_outline_blank</span>
