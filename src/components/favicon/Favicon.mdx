...
/* Letter */
<Favicon type="letter" letter="F" />

/* Icon */
<Favicon type="icon" icon="email" />
...
| -------------- | ----------------------------------------------------------------- | ----------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `type`         | `'letter'` \| `'icon'` \| `'image'`                               | Yes         | N/A     | The type of favicon to render                                                                                                         |
...
- When using `type` `'letter'` the `letter` prop is required.
- When using `type` `'icon'` the `icon` prop is required.
- When using `type` `'image'` the `src` and `alt` props are required.
...
const Component = () => (
	<Favicon type="letter" letter="C" theme={customTheme} />
);
```
...
const Component = () => (
	<Favicon type="letter" letter="O" cssOverrides={customStyles} />
);
```
...
const typographyStyle = `
    ...
    font: ${componentFavicon.md.typography.font};
    letter-spacing: ${componentFavicon.md.typography.letterSpacing};
    font-variation-settings: 'wdth' ${componentFavicon.md.typography.fontWidth};
`;
