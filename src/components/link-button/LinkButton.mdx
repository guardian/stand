...
See the "Custom Component Build" section in the [Button documentation](/docs/stand-tools-design-system-components-button--docs#custom-component-build) for guidance on building a custom LinkButton component without React/Emotion.
