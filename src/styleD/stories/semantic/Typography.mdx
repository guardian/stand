...
A [`Typography` component](/docs/stand-tools-design-system-components-typography--docs) is available to apply these presets to your React components, but you can also use the typography tokens directly in your CSS or JS/TS styles if you prefer.
...
const stringStyleJS = css`
	...
	${convertTypographyToEmotionStringStyle(semanticTypography.bodyCompactMd)}

	/* or direct usage without helper function */
    font: ${semanticTypography.bodyCompactMd.font};
	letter-spacing: ${semanticTypography.bodyCompactMd.letterSpacing};
	font-variation-settings: 'wdth' ${semanticTypography.bodyCompactMd.fontWidth};
`;
const objectStyleJS = {
	// other styles e.g.
	color: semanticcolors.text.strong,
	...
	...convertTypographyToEmotionObjectStyle(semanticTypography.bodyCompactSm),

	// or direct usage without helper function
	font: semanticTypography.bodyCompactSm.font,
	letterSpacing: semanticTypography.bodyCompactSm.letterSpacing,
	fontVariationSettings: `'wdth' ${semanticTypography.bodyCompactSm.fontWidth}`,
};
...
<Canvas layout="padded" of={Presets} />
