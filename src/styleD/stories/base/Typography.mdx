...
See the [semantic typography tokens](/docs/stand-tools-design-system-semantic-typography--docs) for more information on how to use font families in your project.
...
const stringStyleJS = css`
	...
	font-size: ${baseTypography.size['14Rem']};
	font-weight: ${baseTypography.weight.openSans.normal};
	font-variation-settings: 'wdth' ${baseTypography.width.openSans};
...
const objectStyleJS = {
	...
	fontSize: baseTypography.size['14Rem'],
	fontWeight: baseTypography.weight.openSans.normal,
	fontVariationSettings: `'wdth' ${baseTypography.width.openSans}`,
	fontStyle: baseTypography.style.normal,
	lineHeight: baseTypography.lineHeight.normal,
	letterSpacing: baseTypography.letterSpacing.defaultRem,
};
