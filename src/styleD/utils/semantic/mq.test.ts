...
describe('mq', () => {
	describe('from', () => {
		it('produces a min-width query for each breakpoint', () => {
			...
			expect(from.md).toBe('@media (min-width: 830px)');
	...
	describe('until', () => {
		it('produces a max-width query 0.1px below the breakpoint min', () => {
			...
			expect(until.md).toBe('@media (max-width: 829.9px)');
