...
.stand-${kebab} {
	...
	align-items: var(--component-${camel}-shared-align-items);
	justify-content: var(--component-${camel}-shared-justify-content);
	user-select: var(--component-${camel}-shared-user-select);
}
\`;
...
const style = \\\`
	...
	align-items: \\\${component${pascal}.shared["align-items"]};
	justify-content: \\\${component${pascal}.shared["justify-content"]};
	user-select: \\\${component${pascal}.shared["user-select"]};
\\\`;
...
const changesetId = `add-${kebab}-component-${randomBytes(3).toString('hex')}`;
